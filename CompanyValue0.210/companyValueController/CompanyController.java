...
public class CompanyController {
	...
	private CompanyController() {
		returnOnInvestment = new String("10");
	}
	...
	public static void manualValues(int row, HashMap<String, List<String>> profile) {
		...
		System.out.println("runs company controller");
...
//	public static void returnOnInvestment(ReturnOnInvestment rOnI, InfoTablePanel info, FinancialTablePanel fin,
//			ReturnTablePanel ret) {
//		String passReturn = String.valueOf(rOnI.getReturnOnInvestment());
//		Evaluator.recalculate(stocks, passReturn);
//		TableController.refresh(info, fin, ret);
//	}

//	public static void changedMargin(String ticker) {
