...
public class FinancialTableModel extends BaseTableModel {
	...
	private String[] colName = { "Ticker", "Profit Margin (Average)", "Cash Return on Invested Capital (CROIC)",
			"Return on Invested Capital (IC)", "Return on Assets", "Free Cash Flow (FCF)", "Change in FCF",
			"Cash on Hand", "Equity/Debt Ratio", "Change in Debt", "Cash/Debt Ratio" };
