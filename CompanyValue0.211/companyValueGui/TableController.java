		...
		valueCheck.addActionListener((ActionEvent e) -> {
			if (table.getSelectedColumn() != -1 || table.getSelectedRow() != -1) {
				...
				sb.append("Check Against Most Recent Values From Yahoo Finance:\n")
					.append("\nDate of last Annual Report: ").append(CompanyController.getStocks().get(table.getSelectedRow()).getLastDate())
					.append("\n\nIncome Statment:")
					.append("Revenue: ").append(CompanyController.getStocks().get(table.getSelectedRow()).getRevenue())
					.append("\n\nBalance Sheet:\n")
					.append("Assets: ").append(CompanyController.getStocks().get(table.getSelectedRow()).getAssets())
					.append("\n").append("Debt: ")
					.append(CompanyController.getStocks().get(table.getSelectedRow()).getDebt()).append("\n")
					.append("Equity: ").append(CompanyController.getStocks().get(table.getSelectedRow()).getEquity())
