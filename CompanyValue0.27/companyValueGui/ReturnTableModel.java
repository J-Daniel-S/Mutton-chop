...
public class ReturnTableModel extends BaseTableModel {
	...
	private String[] colName = { "Ticker", "Current Price", "Enterprise Value", "EV/EBITDA", "Cash Yield",
			"Buy and Hold Market Value", "Buy and Hold Safe Value", "CROIC", "Change in FCF" };
