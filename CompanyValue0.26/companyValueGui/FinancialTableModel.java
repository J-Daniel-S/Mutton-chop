...
public class FinancialTableModel extends BaseTableModel {
	...
	private String[] colName = { "Ticker", "Enterprise Value", "Profit Margin",
			"Cash Return on Invested Capital", "Return on Assets", "Return on Equity", "Free Cash Flow (FCF)", 
			"Change in FCF", "Cash on Hand", "Equity/Debt Ratio", "Cash/Debt Ratio"
			};
